...
app_name_process="Uninstall Epic Games Store"
app_remove_status="Uninstalling Epic Games Store..."
...
# Uninstall app
function remove_app() {
	if test ! -e "/tmp/regataos-gcs/config/epicstore-games/show-games.txt"; then
