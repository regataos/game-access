...
app_name_process="Desinstalar o Ubisoft Connect"
app_remove_status="Desinstalando o Ubisoft Connect..."
app_executable="drive_c/Program Files/Ubisoft/Ubisoft Game Launcher/UbisoftConnect.exe"
app_executable2="drive_c/Program Files (x86)/Ubisoft/Ubisoft Game Launcher/UbisoftConnect.exe"
