...
app_nickname="amazon"
app_name_process="Desinstalar o Amazon Games"
app_remove_status="Desinstalando o Amazon Games..."
...
# Uninstall app
function remove_app() {
	if test ! -e "/tmp/regataos-gcs/config/amazon-games/show-games.txt"; then
	...
	rm -r "$HOME/.local/share/applications/Amazon Games.lnk"
