...
app_name="Downloading .NET Framework 4.0"
app_nickname="dotnet40"
app_name_process="Download Microsoft .NET Framework 4.0"
app_download_status="Downloading Microsoft .NET Framework 4.0."
