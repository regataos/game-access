...
app_name_down="Downloading Battle.net"
app_name_process="Install Battle.net"
app_install_status="Installing Battle.net..."
...
app_download_status="Downloading Battle.net installer..."
...
function install_app() {
	...
	WINEPREFIX="$app_nickname_dir" wine /tmp/regataos-gcs/$app_download_file_name
}
