...
(
	...
	/opt/regataos-gcs/tools/legendary/legendary import-game -y "$game_id" "$installation_path/" 2>&1 | (pv -n > /var/log/regataos-logs/importing-$game_nickname-epicstore.log)
