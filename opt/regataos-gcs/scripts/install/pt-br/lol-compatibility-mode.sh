...
app_nickname="lol"
app_name_down="Baixando League of Legends"
app_name_process="Instalar League of Legends"
app_install_status="Instalando League of Legends..."
...
#dotnet
app_name_dotnet40="Instalando o .NET Framework 4.0"
app_name_dotnet48="Instalando o .NET Framework 4.8"
install_dotnet_status="Isso pode demorar alguns minutos..."

#Download information
app_download_status="Baixando o instalador do LoL..."
...
export WINEDEBUG=-all; WINEPREFIX="$app_nickname_dir" /opt/regataos-wine/mf-install-master/mf-install.sh start
#tar xf /opt/regataos-wine/mf-install-master/mf-installcab-master.tar.xz -C /tmp/regataos-gcs/
#WINEPREFIX="$app_nickname_dir" /tmp/regataos-gcs/mf-installcab-master/install-mf-32.sh start
#WINEPREFIX="$app_nickname_dir" /tmp/regataos-gcs/mf-installcab-master/install-mf-64.sh start

echo "92%" > $progressbar_dir/progress
